...
I was assigned with the task of making a closed loop autonomous system for the manufacturing. I'm using R to utilize the BO with mlrMBO package. For the automation works, I'm using python. The codes are inside > codes folder. and the main coide is in AIM-Lab-Automation/codes/main program .ipynb.
